...
const ListPage = () => {
  ...
  const todoColumns = [
    { title: 'Controller', dataIndex: 'controller', key: 'controller', width: 90 },
    { title: 'Message', dataIndex: 'message', key: 'message', width: 90 },
  ...
  const doingColums = [
    { title: 'Controller', dataIndex: 'controller', key: 'controller', width: 90 },
    { title: 'Message', dataIndex: 'message', key: 'message', width: 90 },
    { title: 'AGV', dataIndex: 'agv', key: 'agv', width: 90 },
    { title: 'Datetime', dataIndex: 'datetime', key: 'datetime' },
  ];

  const conflictColums = [
    { title: 'AGV', dataIndex: 'agv', key: 'agv', width: 90 },
    { title: 'Space', dataIndex: 'space', key: 'space', width: 90 },
    { title: 'Datetime', dataIndex: 'datetime', key: 'datetime' },
  ];
